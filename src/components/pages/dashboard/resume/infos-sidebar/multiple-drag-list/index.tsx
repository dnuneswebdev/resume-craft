              ...
              {(provided) => (
                ...
                >
                  {fields.map((field, index) => {
                    const titleKey = data.titleKey as keyof typeof field; //keyof typeof necessário pro typescript nao dar erro
                    const descriptionKey =
                      data.descriptionKey as keyof typeof field; //precisa forçar essa tipagem para usar ali no field[title]
